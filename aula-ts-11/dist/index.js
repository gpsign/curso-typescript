...
app.post("/games", validate_1.validate, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, games_service_1.default.createGame(body)];
            case 2:
                _a.sent();
...
app.get("/games", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, games_service_1.default.getGames()];
            case 1:
                games = _a.sent();
                res.send(games.rows);
                return [2 /*return*/];
